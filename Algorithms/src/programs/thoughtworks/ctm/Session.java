...
//Session is a list of task, but contains a duration
...
public class Session extends Tasks {
	...
	/*
	 * static enum SessionType { MORNING {
	 * 
	 * @Override int getDuration(){ return 3; } },EVENING {
	 * 
	 * @Override int getDuration(){ return 4; } }; abstract int getDuration(); }
	 */
	@Override
